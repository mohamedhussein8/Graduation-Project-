...
const Home = () => {
    ...
    <Paper>
      ...
      <p style={{width:'50%', fontFamily:"arial"}}>The goal is to help anyone wishing to consult a doctor online, and to guide them in what they need to know before starting the treatment appropriate for them We work to save people time instead of doing the same themselves through active research and saving their time</p>
      <Link to="/joindoctorteam"><Button1 className="btn btn-success">Join Our Doctor Team</Button1></Link>
      </div>
      </Over2>
    </Paper>
    <div className="one">
      ...
      <div className="container">
        <div className="row" style={{textAlign:'center'}}>
          ...
          <div className="col-md-6" style={{marginTop:'150px' , textAlign:'left'}} data-aos="fade-left">
              <h2 style={{color:'#17a2b8'}}>welcome to Disease Discovery</h2><br />
              <div style={{width:'70%'}}>
              <h5 style={{fontFamily:"Times New Roman"}}>This web application supports and helps people with infectious diseases by reducing all costs and efforts, and easily gets the result of initial diagnosis, you only need to select the disease you expect.
